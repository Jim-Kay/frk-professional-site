  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-accent/30 selection:text-foreground">
      ...
      <main>
        ...
        {/* What I Bring */}
        <section className="py-20 bg-primary text-primary-foreground px-6 border-y border-primary-border relative overflow-hidden">
        ...
        {/* Core Expertise */}
        <section id="expertise" className="py-24 bg-secondary/30 px-6 border-t border-border">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {content.capabilities.map((cap, idx) => (
                <div key={idx} className="bg-background border border-border px-5 py-3 rounded-full text-sm font-medium text-foreground shadow-sm hover:border-accent transition-colors">
                  {cap}
                </div>
              ))}
            </div>
        ...
        {/* Credentials */}
        <section id="credentials" className="py-24 px-6 bg-secondary/30">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <a href="#resume" className="flex items-center justify-between p-6 bg-background rounded-lg border border-border shadow-sm hover:border-primary transition-colors group">
                  <div className="flex items-center gap-4">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {content.testimonials.map((test, idx) => (
                <Card key={idx} className="bg-card border-none shadow-md relative overflow-hidden">
